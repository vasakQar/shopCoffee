            ...
            <table class="table table-condensed">
                ...
                <tr>
                    <td class="cart_product">
                        <a href=""><img src="{{asset('shop_templates/images/cart/one.png')}}" alt=""></a>
                    </td>
                ...
                <tr>
                    <td class="cart_product">
                        <a href=""><img src="{{asset('shop_templates/images/cart/two.png')}}" alt=""></a>
                    </td>
                    <td class="cart_description">
                        <h4><a href="">Colorblock Scuba</a></h4>
                        <p>Web ID: 1089772</p>
                ...
                <tr>
                    <td class="cart_product">
                        <a href=""><img src="{{asset('shop_templates/images/cart/three.png')}}" alt=""></a>
                    </td>
                    <td class="cart_description">
                        <h4><a href="">Colorblock Scuba</a></h4>
                        <p>Web ID: 1089772</p>
