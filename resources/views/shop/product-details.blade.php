            ...
            <div class="row">
                <div class="col-sm-4">
                    <div class="logo pull-left">
                        <a href="index.html"><img src="{{asset('shop_templates/images/home/logo.png')}}" alt="" /></a>
                    </div>
            ...
            <div class="col-sm-3">
                <div class="left-sidebar">
                    ...
                    <div class="shipping text-center"><!--shipping-->
                        <img src="{{asset('shop_templates/images/home/shipping.jpg')}}" alt="" />
                    </div><!--/shipping-->
                ...
                <div class="product-details"><!--product-details-->
                    <div class="col-sm-5">
                        <div class="view-product">
                            <img src="{{asset('shop_templates/images/product-details/1.jpg')}}" alt="" />
                            <h3>ZOOM</h3>
                        </div>
                        <div id="similar-product" class="carousel slide" data-ride="carousel">
                            ...
                            <div class="carousel-inner">
                                <div class="item active">
                                    <a href=""><img src="{{asset('shop_templates/images/product-details/similar1.jpg')}}" alt=""></a>
                                    <a href=""><img src="{{asset('shop_templates/images/product-details/similar2.jpg')}}" alt=""></a>
                                    <a href=""><img src="{{asset('shop_templates/images/product-details/similar3.jpg')}}" alt=""></a>
                                </div>
                                <div class="item">
                                    <a href=""><img src="{{asset('shop_templates/images/product-details/similar1.jpg')}}" alt=""></a>
                                    <a href=""><img src="{{asset('shop_templates/images/product-details/similar2.jpg')}}" alt=""></a>
                    ...
                    <div class="col-sm-7">
                        <div class="product-information"><!--/product-information-->
                            <img src="{{asset('shop_templates/images/product-details/new.jpg" class="newarrival')}}" alt="" />
                            <h2>Anne Klein Sleeveless Colorblock Scuba</h2>
                            <p>Web ID: 1089772</p>
                            <img src="{{asset('shop_templates/images/product-details/rating.png')}}" alt="" />
                            <span>
									<span>US $59</span>
                            ...
                            <a href=""><img src="{{asset('shop_templates/images/product-details/share.png')}}" class="share img-responsive"  alt="" /></a>
                        ...
                        <div class="tab-pane fade" id="details" >
                                ...
                                <div class="product-image-wrapper">
                                    <div class="single-products">
                                        <div class="productinfo text-center">
                                            <img src="{{asset('shop_templates/images/home/gallery1.jpg')}}" alt="" />
                                            <h2>$56</h2>
                            ...
                            <div class="col-sm-3">
                                <div class="product-image-wrapper">
                                    <div class="single-products">
                                        <div class="productinfo text-center">
                                            <img src="{{asset('shop_templates/images/home/gallery2.jpg')}}" alt="" />
                                            <h2>$56</h2>
                                            <p>Easy Polo Black Edition</p>
                                            <button type="button" class="btn btn-default add-to-cart"><i class="fa fa-shopping-cart"></i>Add to cart</button>
                                        </div>
                            ...
                            <div class="col-sm-3">
                                <div class="product-image-wrapper">
                                    <div class="single-products">
                                        <div class="productinfo text-center">
                                            <img src="{{asset('shop_templates/images/home/gallery3.jpg')}}" alt="" />
                                            <h2>$56</h2>
                                            <p>Easy Polo Black Edition</p>
                                            <button type="button" class="btn btn-default add-to-cart"><i class="fa fa-shopping-cart"></i>Add to cart</button>
                                        </div>
                            ...
                            <div class="col-sm-3">
                                <div class="product-image-wrapper">
                                    <div class="single-products">
                                        <div class="productinfo text-center">
                                            <img src="{{asset('shop_templates/images/home/gallery4.jpg')}}" alt="" />
                                            <h2>$56</h2>
                                            <p>Easy Polo Black Edition</p>
                                            <button type="button" class="btn btn-default add-to-cart"><i class="fa fa-shopping-cart"></i>Add to cart</button>
                                        </div>
                        ...
                        <div class="tab-pane fade active in" id="reviews" >
                            <div class="col-sm-12">
                                ...
                                <form action="#">
                                    ...
                                    <b>Rating: </b> <img src="{{asset('shop_templates/images/product-details/rating.png')}}" alt="" />
                            ...
                            <div class="item active">
                                <div class="col-sm-4">
                                    <div class="product-image-wrapper">
                                        <div class="single-products">
                                            <div class="productinfo text-center">
                                                <img src="{{asset('shop_templates/images/home/recommend1.jpg')}}" alt="" />
                                                <h2>$56</h2>
                                                <p>Easy Polo Black Edition</p>
                                                <button type="button" class="btn btn-default add-to-cart"><i class="fa fa-shopping-cart"></i>Add to cart</button>
                                            </div>
                                ...
                                <div class="col-sm-4">
                                    <div class="product-image-wrapper">
                                        <div class="single-products">
                                            <div class="productinfo text-center">
                                                <img src="{{asset('shop_templates/images/home/recommend2.jpg')}}" alt="" />
                                                <h2>$56</h2>
                                                <p>Easy Polo Black Edition</p>
                                                <button type="button" class="btn btn-default add-to-cart"><i class="fa fa-shopping-cart"></i>Add to cart</button>
                                            </div>
                                ...
                                <div class="col-sm-4">
                                    <div class="product-image-wrapper">
                                        <div class="single-products">
                                            <div class="productinfo text-center">
                                                <img src="{{asset('shop_templates/images/home/recommend3.jpg')}}" alt="" />
                                                <h2>$56</h2>
                                                <p>Easy Polo Black Edition</p>
                                                <button type="button" class="btn btn-default add-to-cart"><i class="fa fa-shopping-cart"></i>Add to cart</button>
                                            </div>
